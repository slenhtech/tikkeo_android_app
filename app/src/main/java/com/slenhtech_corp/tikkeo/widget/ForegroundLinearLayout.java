...
public class ForegroundLinearLayout extends LinearLayout {
    ...
    public ForegroundLinearLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mForegroundGravity = a.getInt(R.styleable.ForegroundView_android_foreground, mForegroundGravity);
        ...
        mForegroundInPadding = a.getBoolean(R.styleable.ForegroundView_android_foregroundInsidePadding, true);
